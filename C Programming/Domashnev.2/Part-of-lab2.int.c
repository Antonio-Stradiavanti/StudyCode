...
int main()
{
	...
	char isexit;
    // Поисковой запрос
	char argItem1 = 'N'; int argPrice1 = 886; char argItem2 = 'R'; int argPrice2 = 777;
    //do
	//{
        //fflush(stdin); 
        ...
        //scanf("%c %d %c %d", &argItem1, &argPrice1, &argItem2, &argPrice2);
        //printf("\nArg1: %c;\nArg2: %d;\nArg3: %c;\nArg4: %d;\n", argItem1, argPrice1, argItem2, argPrice2);
        ...
        // Запрашиваю ввода пользователем аргумента многоаспектного поиска
        //printf("Enter a search query in the following order:\n[1 -> (char) item1; 2 -> (int) price1; 3 -> (char) item2; 4 -> (int) price2]\n");
