...
void help()
{
  ...
  cout << "10 -> Удалить все элементы из контейнера" << endl;
  cout << "11 -> Вывод справки." << endl;
}
void menu(multiset<int> &A)
{
  ...
  while(1)
  {
    ...
    switch (c)
    {
        ...
        case 10:
            A.clear();
            cout << "[menu->8->out] : Все элементы из контейнера успешно удалены." << endl;
        break;
        case 11:
          cout << "[menu->11->out] Вывод справки." << endl;
        break;
        default:
        break;
    }
